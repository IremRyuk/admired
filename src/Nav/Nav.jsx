...
const lang = useSelector(res=>res.flag)
    ...
    return(
        <div className="nav">
            ...
            <p className='nav-cat' onClick={()=>navigate('/gifts')}>{lang==='namesGeo'?'საჩუქარი':lang==='namesRus'?"Подарок":'Gifts'}</p>
            </div>
            {/* Socials */}
...
<p className='mini-nav-cat' onClick={()=>{navigate('/gifts'),setOpen(e=>!e)}}>{lang==='namesGeo'?'საჩუქარი':lang==='namesRus'?"Подарок":'Gifts'}</p>
</div>
